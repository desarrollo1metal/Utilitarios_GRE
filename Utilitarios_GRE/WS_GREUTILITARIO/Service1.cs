...
namespace WS_GREUTILITARIO
{
    public partial class Service1 : ServiceBase
    {
        ...
        private Timer timer;
        private int pauseTimeInMilliseconds;
        ...
        public Service1()
        {
            ...
            Log.Logger = new LoggerConfiguration()
                //.WriteTo.Console() // Opcional: para desarrollo
                .WriteTo.File("logs\\myapp.txt", rollingInterval: RollingInterval.Day) // Logs en archivo
                .WriteTo.EventLog("MyService", manageEventSource: true) // Logs en el Visor de Eventos
                .CreateLogger();


            timer = new Timer();
            timer.Interval = time_event;// 5000; // Intervalo de 5 segundos
            timer.Elapsed += new ElapsedEventHandler(procesar);
            timer.AutoReset = true; // Repetir indefinidamente
        ...
        protected override void OnStart(string[] args)
        {
            ...
            // Iniciar el Timer cuando el servicio comienza
            timer.Enabled = true;
        ...
        protected override void OnStop()
        {
            ...
            Log.Information("*********** WS Aplicación detenida. ***********");
            //timer.Stop();
        ...
        public void procesar(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //            cmd.Parameters.AddWithValue("@v_compania ", SqlDbType.NVarChar).Value = "1000";
            ...
            {
                Log.Error(ex, "Error en el procesamiento.");
            }
        ...
        private void GRE_Utilitario()
        {
            ...
            Log.Information("Comenzar LeerConfig()");
        ...
        public bool procesarXMLAdjuntoSAP(string archivot, string namefile, string oringT, string destinot, string PathFirmaErrort)
        {
