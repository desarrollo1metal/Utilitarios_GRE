...
namespace WS_GRE_TOOL
{
    class sapObjUser
    {
        ...
        private static readonly log4net.ILog logger = log4net.LogManager.GetLogger(typeof(sapObjUser));
            ...
            string[] validDescription, string valorPorDef, string tablaVinculada, string UDOVinculado)
        {
            ...
            try
            {
                ...
                if (m_iErrCode != 0)//Validamos que no se hayan producido errores
                {
                    ...
                    logger.Debug("codigo error : " + m_iErrCode.ToString() + " -- mensaje : " + m_sErrMsg.ToString());
                ...
                {
                    logger.Debug(" Se ha creado el campo de usuario: " + NombreCampo + "en la tabla: " + NombreTabla);
            ...
            finally
            {
                ...
                try
                {
                    if (oUserFieldsMD != null)
                    {
                        ...
                        logger.Debug("Objeto Liberado - creado de campos" );
                    }
                }
                catch (Exception ex)
                {
